...
<html lang="en">
  <head>
   ...
   <script src="https://kit.fontawesome.com/4942c928be.js" crossorigin="anonymous"></script>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="{{ route('password.change')}}"><i class="icon ion-ios-folder-outline"></i> Password Change</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
